  ...
  return (
    <div className="relative overflow-hidden bg-[#FAFCFF] pt-28 pb-16">
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute -top-[10%] left-[-10%] h-[600px] w-[600px] rounded-full bg-[#0066FF]/5 blur-[120px]" />
        <div className="absolute top-[40%] right-[-5%] h-[500px] w-[500px] rounded-full bg-[#7DBBFF]/10 blur-[100px]" />
      </div>
